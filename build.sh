    ...
    --sideloaded)
      ...
      if [ -e ./packages/com.atebits.Tweetie2.ipa ]; then
        ...
        cyan -i packages/com.atebits.Tweetie2.ipa -o packages/BHTwitter-sideloaded --ignore-encrypted \
          -uwf .theos/obj/debug/keychainfix.dylib .theos/obj/debug/BHTwitter.dylib .theos/obj/debug/libbhFLEX.dylib layout/Library/Application\ Support/BHT/BHTwitter.bundle
